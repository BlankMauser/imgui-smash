...
CIMGUI_API bool igBeginChild_Str(const char* str_id,const ImVec2_c size,bool border,ImGuiWindowFlags flags)
{
    return ImGui::BeginChild(str_id,ConvertToCPP_ImVec2(size),border,flags);
}
CIMGUI_API bool igBeginChild_ID(ImGuiID id,const ImVec2_c size,bool border,ImGuiWindowFlags flags)
{
...
CIMGUI_API void igImage(ImTextureID user_texture_id,const ImVec2_c size,const ImVec2_c uv0,const ImVec2_c uv1,const ImVec4_c tint_col,const ImVec4_c border_col)
{
    return ImGui::Image(user_texture_id,ConvertToCPP_ImVec2(size),ConvertToCPP_ImVec2(uv0),ConvertToCPP_ImVec2(uv1),ConvertToCPP_ImVec4(tint_col),ConvertToCPP_ImVec4(border_col));
}
CIMGUI_API bool igImageButton(const char* str_id,ImTextureID user_texture_id,const ImVec2_c size,const ImVec2_c uv0,const ImVec2_c uv1,const ImVec4_c bg_col,const ImVec4_c tint_col)
{
...
CIMGUI_API bool igBeginTable(const char* str_id,int column,ImGuiTableFlags flags,const ImVec2_c outer_size,float inner_width)
{
...
CIMGUI_API bool igBeginChildFrame(ImGuiID id,const ImVec2_c size,ImGuiWindowFlags flags)
{
